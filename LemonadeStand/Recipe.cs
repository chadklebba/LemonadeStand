...
namespace LemonadeStand
{
    class Recipe
    {
        ...
        {
            Console.WriteLine("How many lemons would you like to use per cup?");
            try
            {
            ...
            lemons = newLemons;
            Console.WriteLine("How many cups of sugar would you like to use per cup?");
            try
            {
        ...
        {
            Console.WriteLine("How much would you like to charge per cup? (ex. .20)");
            try
            {
