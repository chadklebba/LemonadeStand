...
namespace LemonadeStand
{
    class Store
    {
        ...
        public void BuyLemons(Player player)
        {
            ...
            Console.WriteLine("Lemons cost .05 each, you currenty have " + player.inventory.lemons + " lemons. How many would you like to buy?");
            try
            {
        ...
        public void BuySugar(Player player)
        {
            int newSugar = 0;
            Console.WriteLine("You currently have $" + player.wallet.balance + " in your wallet" + "\r");
            Console.WriteLine("Sugar costs .03 per cup, you currenty have " + player.inventory.sugar + " cups of sugar." + " How many cups would you like to buy?");
            try
            {
        ...
        public void BuyIceCubes(Player player)
        {
            int newIceCubes = 0;
            Console.WriteLine("You currently have $" + player.wallet.balance + " in your wallet" + "\r");
            Console.WriteLine("Ice cubes costs .01 per ice cube, you currenty have " + player.inventory.iceCubes + " ice cubes." + " How many ice cubes would you like to buy?");
            try
            {
